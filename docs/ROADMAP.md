...
**Corrélation RAM / profil dans les rapports.** Les rapports hebdomadaires actuels comptent les switchs mais ne mesurent pas l'impact réel. Ajouter la RAM moyenne constatée par profil (depuis l'historique des mesures monitoring) transformerait le rapport en un outil d'aide à la décision : "cette semaine en mode WEB, tu as utilisé en moyenne 1.4GB — peut-être que 2GB est surdimensionné pour toi."
