...
- [x] ~~Resynchroniser le depot `wisely-site`~~ (verifie le 2026-09-03 - deja fait sans action dediee : changelog.ts va desormais jusqu'a v3.0.0, couvre P0/v2.5, P1/v2.6 et P2/v3.0)
